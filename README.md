...
(this is a fork; the real work was done by [smartcontracts](https://github.com/smartcontracts/simple-optimism-node). my contribution is the [#Detailed-Instructions](https://github.com/kethcode/simple-optimism-node/tree/main#detailed-instructions))
